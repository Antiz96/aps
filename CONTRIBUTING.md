...
Thank you for considering contributing to [aps](https://github.com/Antiz96/aps)!
...
**Note:** To report security concerns, please follow the instructions in the [SECURITY.md](https://github.com/Antiz96/aps/blob/main/SECURITY.md) document.

Before [opening an issue](https://github.com/Antiz96/aps/issues/new/choose), verify that there isn't one already open on the same (or a similar) subject.
...
Make sure to create your merge request from a dedicated branch (do not use the `main` branch) and to provide the information requested in the [pull request template](https://github.com/Antiz96/aps/blob/main/.github/PULL_REQUEST_TEMPLATE.md).
...
Closes https://github.com/Antiz96/aps/issues/163
```
...
Fixes https://github.com/Antiz96/aps/issues/103
```
...
Closes https://github.com/Antiz96/aps/issues/230

BREAKING CHANGE: People that installed aps from source will have to uninstall it (with `make uninstall`) **before** pulling and installing the new version (with `make install`). Otherwise, some files will remain un-tracked on the system.
```

### License

By contributing to this project, you agree that your contributions will be licensed under the [GPL-3.0 license](https://github.com/Antiz96/aps/blob/main/LICENSE) (or any later version of this license).
...
Once again, thank you for considering contributing to aps!  
I'd also like to sincerely thank everyone that gave aps a star, opened issues, feature requests, pull requests or contributed to this project in any other way! :heart:
